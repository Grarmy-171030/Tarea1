...
peso_de_muñeca = 75   # gramos
numero_de_payaso = int(input("Ingrese el número de payasos: "))
numero_de_muñeca = int(input("Ingrese el número de muñecas: "))
peso_total = (numero_de_payaso * peso_de_payaso) + (numero_de_muñeca * peso_de_muñeca)
